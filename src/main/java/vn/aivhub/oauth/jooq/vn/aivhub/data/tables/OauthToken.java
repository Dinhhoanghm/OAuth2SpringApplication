...
public class OauthToken extends TableImpl<OauthTokenRecord> {
     ...
     */
    public static final TableField<OauthTokenRecord, String> REFRESH_TOKEN = createField(DSL.name("refresh_token"), SQLDataType.VARCHAR(200), OAUTH_TOKEN, "");

    /**
     * The column <code>public.oauth_token.access_token</code>.
     */
    public static final TableField<OauthTokenRecord, String> ACCESS_TOKEN = createField(DSL.name("access_token"), SQLDataType.VARCHAR(200), OAUTH_TOKEN, "");
